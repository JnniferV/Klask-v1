...
class ScanController extends AbstractController
{
    ...
    // scan via scanner natif du téléphone (URL dans le QR) — PUBLIC
    //Si connecté : affiche une page de confirmation légère puis redirige /map
     //Si non connecté : stocke le token en session : /inscription
