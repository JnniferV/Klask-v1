...
class ActivityCategoryFixtures extends Fixture
{
    ...
    {
        // Stand sphère — 50 pts si la sphère est dans le top 3 de l'élève, 25 sinon (cf. ScanService::resolvePoints)
        ...
        // Profession — rencontre « métier » (points propres, paramétrables via le CRUD Catégories)
