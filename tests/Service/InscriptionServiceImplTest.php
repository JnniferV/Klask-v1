...
class InscriptionServiceImplTest extends TestCase
{
    private function service(
        ...
        return new InscriptionServiceImpl(
            $authorityRepository ?? $this->createMock(AuthorityRepository::class),
    ...
    public function testRefusQuandLeCodeDeGroupeEstInconnu(): void
    {
        ...
        $this->assertSame('Code de groupe invalide. Vérifiez le code avec votre accompagnateur.', $refus);
    }
    ...
    public function testRefusQuandLeGroupeAtteintQuaranteEleves(): void
    {
        ...
        $plein = $this->createMock(GroupRepository::class);
        $plein->method('countUsersByGroupId')->willReturn(40); // MAX_STUDENTS_PER_GROUP = 40 parametre de l'app
    ...
    public function testUnQuaranteEtUniemeEleveEstEncoreAccepteATrenteNeuf(): void
    {
        ...
        $presquePlein = $this->createMock(GroupRepository::class);
    ...
    {
        $authorityRepository = $this->createMock(AuthorityRepository::class);
        $authorityRepository->method('findByRole')->willReturn(null);
    ...
    public function testLInscriptionAffecteLAutoriteStudentEtConserveLePseudoLibre(): void
    {
        ...
        $authorityRepository = $this->createMock(AuthorityRepository::class);
        $authorityRepository->method('findByRole')->willReturn($authority);

        $userRepository = $this->createMock(UserRepository::class);
        $userRepository->method('findTakenPseudos')->willReturn([]); // pseudo dispo
    ...
    {
        $authorityRepository = $this->createMock(AuthorityRepository::class);
        $authorityRepository->method('findByRole')->willReturn(new Authority());
